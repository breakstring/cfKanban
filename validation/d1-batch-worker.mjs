...
async function seed(db) {
  await db.batch([
    ...
    db.prepare("INSERT INTO public_join_policies (project_id, workspace_id, project_key, public_id, public_summary, enabled_at, enabled_by_principal_id, created_at, updated_at) VALUES ('project', 'workspace', 'CORE', 'public', 'Public', ?, 'owner', ?, ?)").bind(now, now, now),
