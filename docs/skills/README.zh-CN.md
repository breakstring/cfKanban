...
`1.0.0-rc.6` 包含四个 Skills：一个使用指南和三个操作技能：
...
当前测试发行指针是 <https://github.com/breakstring/cfKanban/releases/download/1.0.0-rc.6/prerelease.json>。只有用户明确选择测试发行版后，`cfkanban-deploy` 才能使用它。
