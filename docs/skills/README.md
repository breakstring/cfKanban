...
`1.0.0-rc.5` contains four Skills: one usage guide and three operational Skills:
...
The current testing release pointer is <https://github.com/breakstring/cfKanban/releases/download/1.0.0-rc.5/prerelease.json>. `cfkanban-deploy` may use it only after the user explicitly chooses the testing prerelease.
