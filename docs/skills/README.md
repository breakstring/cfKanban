...
The current testing release pointer is <https://github.com/breakstring/cfKanban/releases/download/0.1.0-alpha.37/prerelease.json>. `cfkanban-deploy` may use it only after the user explicitly chooses the testing prerelease.
