...
- Foundation、Agent Skills & Bootstrap、API/Schema、Web UI 与 `DESIGN.md` 均已冻结为 v0 实现基线；Foundation 当前为修订 19，Agent Skills & Bootstrap 为修订 24。实现状态以 Linear 为准，合同冻结本身不表示对应 Issue 已完成。
