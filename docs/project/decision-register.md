...
Foundation 的领域与服务端公共技术选择、Agent-first Storyboard 及首发 Skill/部署体验已经完成第一轮收敛，两份 SPEC 已于 2026-08-28 按 D-212 冻结。Foundation 当前为修订 13；Agent Skills & Bootstrap 已按 D-236/D-237/D-239 修订到 14，固定首次 Owner 名称输入、首次加入合并确认和 pending Credential 恢复。D-235/D-238 进入 Draft Web UI 合同。Web UI 和 API/Schema 仍为 Draft，不因此获得实现授权。
