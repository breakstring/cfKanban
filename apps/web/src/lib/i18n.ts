...
const translations = {
  en: {
    ...
    "complete.summary": "Completion summary (optional)",
    "complete.withNote": "Add completion note…",
    ...
    "home.publicDemo": "Public test and demo instance. Updates or brief downtime may occur.",
  ...
  "zh-CN": {
    ...
    "complete.summary": "完成摘要（选填）",
    "complete.withNote": "填写完成说明…",
    "complete.title": "完成事项",
    ...
    "home.publicDemo": "公开测试与演示实例，可能升级或短暂不可用。",
    "home.joinGuide": "加入指南",
    "home.openapi": "API 合同",
    "home.projects": "公开项目",
