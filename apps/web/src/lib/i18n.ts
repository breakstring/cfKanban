...
const translations = {
  en: {
    ...
    "home.agentInstruction": "Please read https://github.com/breakstring/cfKanban#readme and help me install or update cfKanban Skills from the project's official source, then deploy a new instance.",
    "home.description": "A lightweight coordination board where Agents discover, assign, advance, and hand off work within explicit scope, while everyone shares the same project facts.",
    "home.heading": "Let Agents move work forward. Collaborate from shared facts.",
  ...
  "zh-CN": {
    ...
    "error.authorization": "当前会话不允许此操作，请刷新或重新登录。",
    ...
    "error.platform": "服务暂时不可用。请保留请求 ID 后重试，或联系实例所有者。",
    "error.platformQuota": "Cloudflare 平台容量暂时不可用。请等待所示重置时间，或联系实例所有者。",
    "error.rate": "请求过于频繁，请稍后再试。",
    "error.session": "会话已结束，当前页面中的远端项目数据已清除。",
    "error.validation": "请检查输入后重试。",
    "home.agentInstruction": "请仔细阅读 https://github.com/breakstring/cfKanban#readme，帮我从项目声明的官方来源安装或更新 cfKanban 技能，并部署一个新实例。",
    "home.description": "面向人与 Agent 的轻量协调看板：Agent 在明确权限内发现、分配、推进和交接工作，所有参与者共享同一份项目事实。",
    "home.heading": "让 Agent 推进，凭事实协作。",
    "home.independent": "这是一个独立部署的 cfKanban 实例。",
    "home.projects": "公开项目",
    "home.projectsDescription": "选择一个公开项目，以只读或协作方式加入。",
    "home.reader": "以只读方式加入",
    "home.writer": "以协作方式加入",
    "issue.activity": "活动",
    "issue.assignee": "负责人",
