...
const translations = {
  en: {
    ...
    "home.description": "Hand the work to Agents; keep status, ownership, and outcomes on one board. People can see what is happening and step in when it matters.",
    "home.heading": "Let Agents do the work. Skip the guesswork.",
  ...
  "zh-CN": {
    ...
    "home.description": "把活儿交给 Agent，把状态、责任和结果留在同一块看板上。人随时能看懂，也随时能接手。",
    "home.heading": "活儿让 Agent 干，进度不用猜。",
