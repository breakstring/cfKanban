...
const translations = {
  en: {
    ...
    "home.agentGuideDescription": "Before deploying: have Node.js and Wrangler ready, and sign in to Cloudflare.",
  ...
  "zh-CN": {
    ...
    "home.agentGuideDescription": "部署前：备好 Node.js、Wrangler，并登录 Cloudflare。",
