...
const TESTING_RELEASE_CONFIG = JSON.parse(await readFile(new URL("../../release/config/1.0.0-rc.7.json", import.meta.url), "utf8"));
...
test("one-time capability creation is blocked on generic API output and uses dedicated delivery", async (t) => {
  ...
  const browserFetch = async (url, options) => {
    ...
    return new Response(JSON.stringify({
      event_cursor: "eyJmaWx0ZXJfaGFzaCI6ImJyb3dzZXItbGF1bmNoIn0",
...
test("public Agent-facing documents avoid the internal stage label", async () => {
  const publicDocuments = [
    ...
    "../../release/notes/0.1.0-alpha.57.md",
    "../../release/notes/0.1.0-alpha.58.md",
    "../../release/notes/0.1.0-alpha.59.md",
    "../../release/notes/0.1.0-alpha.60.md",
    "../../release/notes/1.0.0-rc.1.md",
    "../../release/notes/1.0.0-rc.2.md",
    "../../release/notes/1.0.0-rc.3.md",
    "../../release/notes/1.0.0-rc.4.md",
    ...
    "../../release/config/0.1.0-alpha.57.json",
    "../../release/config/0.1.0-alpha.58.json",
    "../../release/config/0.1.0-alpha.59.json",
    ...
    "../../release/config/1.0.0-rc.4.json",
