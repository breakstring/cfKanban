...
const TESTING_RELEASE_CONFIG = JSON.parse(await readFile(new URL("../../release/config/0.1.0-alpha.34.json", import.meta.url), "utf8"));
...
test("public Agent-facing documents avoid the internal stage label", async () => {
  const publicDocuments = [
    ...
    "../../release/notes/0.1.0-alpha.34.md",
    ...
    "../../release/config/0.1.0-alpha.34.json",
