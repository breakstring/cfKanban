...
import { reconcileMigrationState, writeMigrationLedgerRecordSql } from "./migrations.mjs";
...
const COMMANDS = new Map([
  ...
  ["release verify", command({ description: "Verify the stable pointer, immutable manifest, allowed origins, and both artifact digests.", effect: "read_only", inputFields: ["stablePath", "manifestPath", "artifactFiles"], surfaces: ["deploy"], run: loadAndVerifyRelease })],
