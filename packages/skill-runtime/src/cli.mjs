...
const COMMANDS = new Map([
  ...
  ["credential verify-and-promote", command({ description: "Authenticate with the pending Credential, require consistent /me Principal IDs, an explicit Owner flag, and the exact Credential ID/fingerprint before promotion.", effect: "authenticated_read_and_local_secret_write", inputFields: ["instanceId"], run: verifyPendingCredential })],
