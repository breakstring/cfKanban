...
async function snapshot(client, target) {
  ...
  if (!Number.isSafeInteger(row.schema_version) || row.schema_version < 1 || row.schema_version > 11) fail("OWNER_RECOVERY_SCHEMA_UNSUPPORTED", "This Skill does not support the deployed schema for Owner recovery");
